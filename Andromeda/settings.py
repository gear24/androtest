...
#SECRET_KEY = 'django-insecure-ku0g-gbbbe)3pv)wy%u8g_ccqth)qii@puh09@xcnj-4jx!&8n'
SECRET_KEY = os.environ.get('SECRET_KEY', default="papas")
...
"""     'default': dj_database_url(
        default='postgresql://postgres:postgres@localhost:5432/andromeda',
        conn_max_age=600,
    ) """
